...
{
    public abstract class CV_AbpWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CV_AbpWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CV_AbpWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CV_AbpDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CV_AbpDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CV_AbpDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CV_AbpDbContext, Task<T>> func)
        {
            T result;
